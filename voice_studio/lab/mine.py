...
Đầu vào: nhiều file audio của CÙNG một người. Đầu ra: <VOICE_STUDIO_WORK>/lab/<name>/candidates.json
...
tuyệt đối giữa các giọng là vô nghĩa; chỉ so mỗi người với chính họ mới ra sắc thái.
  ...
  voice-studio lab mine --dir "recordings/speaker-a" --name narrator
"""
import argparse
import glob
import json
